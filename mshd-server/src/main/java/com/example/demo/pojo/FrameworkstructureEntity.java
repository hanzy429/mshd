...
@Entity
@Table(name = "frameworkstructure", schema = "mydb", catalog = "")
public class FrameworkstructureEntity {
    private String id;
    private String date;
    ...
    @Basic
    @Column(name = "reportingunit", nullable = false, length = 24)
    ...
    public boolean equals(Object o) {
        ...
        FrameworkstructureEntity that = (FrameworkstructureEntity) o;
