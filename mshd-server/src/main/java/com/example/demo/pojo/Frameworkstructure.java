...
public class Frameworkstructure {
  ...
  private String slight_Damaged_Square;
  private String moderate_Damaged_Square;
  private String serious_Damaged_Square;
  ...
  public String getSlight_Damaged_Square() {
    return slight_Damaged_Square;
  }

  public void setSlight_Damaged_Square(String slight_Damaged_Square) {
    this.slight_Damaged_Square = slight_Damaged_Square;
  }


  public String getModerate_Damaged_Square() {
    return moderate_Damaged_Square;
  }

  public void setModerate_Damaged_Square(String moderate_Damaged_Square) {
    this.moderate_Damaged_Square = moderate_Damaged_Square;
  }


  public String getSerious_Damaged_Square() {
    return serious_Damaged_Square;
  }

  public void setSerious_Damaged_Square(String serious_Damaged_Square) {
    this.serious_Damaged_Square = serious_Damaged_Square;
  }
